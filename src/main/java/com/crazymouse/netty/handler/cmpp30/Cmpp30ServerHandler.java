...
public class Cmpp30ServerHandler extends SimpleChannelHandler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(Cmpp30ServerHandler.class);
